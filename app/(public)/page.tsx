...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl reveal transition-all duration-1000">
              ...
              <h2 className="font-serif font-bold text-[clamp(2.5rem,5vw,3.5rem)] leading-tight text-maroon mb-4">Our Practice Areas</h2>
              <div className="w-16 h-1 bg-linear-to-r from-maroon to-maroon-light rounded-full" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {displayedAreas.slice(0, 6).map((area, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 text-maroon text-xs font-bold uppercase tracking-[0.2em] transform translate-x-[-10px] opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="reveal transition-all duration-1000" style={{ transitionDelay: "0.2s" }}>
              ...
              <h2 className="font-serif font-bold text-[clamp(2.5rem,5vw,4rem)] leading-tight text-maroon mb-8 italic">Focused on Your Success</h2>
              <div className="w-16 h-1 bg-linear-to-r from-maroon to-maroon-light rounded-full mb-10" />
              <div className="space-y-8 text-slate-mid text-lg leading-relaxed mb-12">
                ...
                <div className="grid grid-cols-2 gap-8">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 text-maroon font-bold text-sm tracking-wide transition-all hover:text-maroon-light underline-offset-4 hover:underline">
        ...
        <section className="py-32 bg-gray-soft">
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-20 reveal transition-all duration-1000">
              ...
              <h2 className="font-serif font-bold text-[clamp(2.5rem,5vw,3.5rem)] leading-tight text-maroon mb-6">Our Elite Attorneys</h2>
              <div className="w-16 h-1 bg-linear-to-r from-maroon to-maroon-light rounded-full mx-auto" />
                ...
                >
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden mb-8 relative shadow-xl">
                    {lawyer.image ? (
                      ...
                      <div className="w-full h-full bg-slate-200 flex items-center justify-center text-slate-400 font-serif italic text-maroon/20">R&A</div>
                    )}
                    <div className="absolute inset-0 bg-linear-to-t from-maroon/90 via-maroon/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
                  ...
                  <h3 className="font-serif font-bold text-2xl text-maroon group-hover:text-maroon-light transition-colors duration-300">
                    {lawyer.name}
                  </h3>
                  <p className="text-maroon-light text-[10px] font-bold uppercase tracking-[0.3em] mt-2 opacity-80">
                    {lawyer.title}
                  </p>
                </Link>
              ))}
      ...
      {/* ─────────── TESTIMONIALS / QUOTE ─────────── */}
      <section className="py-32 bg-white text-maroon relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-[0.03] pointer-events-none">
          <svg className="h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <path d="M100 0 L100 100 L0 100 Z" fill="#7C1D1D" />
          </svg>
        </div>
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center reveal transition-all duration-1000">
            <div className="text-maroon text-7xl font-serif opacity-10 mb-10 leading-none">"</div>
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-serif italic font-medium leading-[1.4] mb-12 text-maroon">
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-[2px] bg-maroon-light mb-6" />
              <div className="font-bold tracking-[0.4em] uppercase text-xs text-maroon mb-2">Rizaldi & Associates</div>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
              <div className="reveal transition-all duration-1000">
                ...
                <h2 className="font-serif font-bold text-[clamp(2.5rem,5vw,3.5rem)] leading-tight text-maroon mb-6">Latest Legal Intelligence</h2>
                <div className="w-16 h-1 bg-linear-to-r from-maroon to-maroon-light rounded-full" />
              </div>
              <Link href="/news/articles" className="group text-[12px] text-maroon font-bold uppercase tracking-[0.2em] flex items-center gap-3 transition-all hover:text-maroon-light">
                ...
                >
                  <div className="h-64 bg-gray-soft relative overflow-hidden">
                    {article.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-maroon/20 font-serif italic text-4xl opacity-20">📰</div>
                    )}
                  ...
                  <div className="p-10">
                    ...
                    <h3 className="font-serif font-bold text-2xl text-maroon mb-6 group-hover:text-maroon-light transition-colors duration-300 line-clamp-2 min-h-[4rem]">
                      {article.title}
                    </h3>
                    <p className="text-slate-mid text-base leading-relaxed mb-8 line-clamp-3 italic opacity-80">
                      {article.excerpt}
                    </p>
                    <div className="flex items-center gap-2 text-maroon-light text-[10px] font-bold uppercase tracking-[0.3em] transform translate-x-[-10px] group-hover:translate-x-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gray-soft border border-gray-100 rounded-[40px] p-12 md:p-24 text-maroon relative overflow-hidden shadow-2xl reveal transition-all duration-1000">
            ...
            <div className="absolute inset-0 opacity-[0.02] pointer-events-none"
              style={{
                backgroundImage: "radial-gradient(circle at 100% 0%, #7C1D1D 0%, transparent 60%)",
              }}
            />

            <div className="relative z-10 grid lg:grid-cols-[1fr_auto] gap-20 items-center">
              <div>
                <h2 className="text-4xl md:text-6xl font-serif font-bold mb-8 italic text-maroon">Securing Your Future</h2>
                ...
                <div className="flex flex-wrap gap-12 pt-10 border-t border-gray-200">
                  <div className="flex flex-col gap-2">
                    <span className="text-maroon-light text-[10px] font-bold uppercase tracking-[0.4em] opacity-60">Direct Dial</span>
                  ...
                  <div className="flex flex-col gap-2">
                    <span className="text-maroon-light text-[10px] font-bold uppercase tracking-[0.4em] opacity-60">Electronic Mail</span>
                    <div className="flex items-center gap-4">
