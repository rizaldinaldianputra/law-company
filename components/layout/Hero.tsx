...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ─── INTERACTIVE GLOW ─── */}
      <div
        className="absolute w-[800px] h-[800px] rounded-full opacity-30 blur-[120px] pointer-events-none z-0"
        style={{
      ...
      <div className="container mx-auto px-6 relative z-10 text-center py-32 lg:py-48">
        ...
        <div className="inline-flex overflow-hidden mb-10 -translate-y-[20px] animate-fade-in-up"
          ...
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 shadow-2xl inline-flex items-center gap-2 px-6 py-2 rounded-full">
        ...
        <div className="max-w-5xl mx-auto space-y-4">
          <div className="overflow-hidden">
            <h1 className="text-white font-serif font-bold italic text-4xl sm:text-6xl md:text-7xl lg:text-8xl animate-mask-up drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
          ...
          <div className="relative py-4 flex items-center justify-center">
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[1px] bg-linear-to-r from-transparent via-gold to-transparent w-full max-w-lg opacity-50" />
            <div className="px-6 bg-black relative z-10 overflow-hidden">
              <h2 className="text-gold font-serif font-bold italic text-2xl sm:text-3xl md:text-4xl lg:text-5xl animate-mask-up drop-shadow-[0_10px_30px_rgba(0,0,0,0.3)]"
                style={{ animationDelay: "0.8s" }}>
                With <span className="bg-linear-to-r from-[#B8922A] via-[#E2C47A] to-[#B8922A] bg-[length:200%_auto] bg-clip-text text-transparent animate-shimmer italic">Absolute Integrity</span>
              </h2>
            </div>
          </div>

          <div className="overflow-hidden">
            <h1 className="text-white/95 font-serif font-bold text-4xl sm:text-6xl md:text-7xl lg:text-8xl animate-mask-up drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-8 animate-fade-in-up"
          ...
          <Link
            href="/contact"
            className="bg-maroon text-white font-bold tracking-[0.1em] uppercase text-[13px] py-4 px-9 rounded-sm flex items-center gap-3 transition-all duration-300 hover:bg-maroon-dark hover:-translate-y-0.5 hover:shadow-[0_10px_25px_rgba(124,29,29,0.4)] shadow-2xl"
            style={{
      ...
      <div className="absolute inset-0 pointer-events-none z-0 opacity-10">
        <Scale size={200} className="absolute -top-10 -left-10 text-gold/20 animate-float" />
        <Shield size={180} className="absolute -bottom-10 -right-10 text-maroon/20 animate-float" style={{ animationDelay: "2s" }} />
      </div>
